...
def sample_event_with_session():
    ...
    """
    return {"input": {"text": "テストメッセージです"}, "sessionId": "test-session-001", "actorId": "test-user-001"}
...
def sample_s3_event():
    ...
    """
    return {"input": {"text": ""}, "s3_info": {"bucket": "test-bucket", "key": "test-folder/test-file.txt"}}
